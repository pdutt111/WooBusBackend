...
router.post('/protected/info/bus',params({body:['bus_identifier','fare','departure_time','route','total_seats','row_seats'],headers:['authorization']},{message : config.get('error.badrequest')}),
    function(req,res,next) {
        operatorLogic.verifyOperator(req,res)
            .then(function(){
                next();
